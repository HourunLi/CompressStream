...
public class Main implements Runnable {
    ...
    public final static int TUPLE_SIZE = 18;
    ...
    static {
        System.load("/root/zhangyu/stream/CompressStream-server/example/SG/Elias_Gamma/libtest.so");
    }
    ...
    public static String EncodingEliasGammaCoding(int d) {
        ...
        int l = (int)( (double)Math.log((double)num)/Math.log((double)2) );
